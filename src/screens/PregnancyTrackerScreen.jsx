      ...
      <div style={styles.body}>
        <div className="fade-up-1">
          <Card accentColor="#FF9A5C">
            <p style={{ ...styles.cardLabel, color: "#ffbe8f" }}>👶 Week 1 of 40</p>
            <p style={styles.cardBody}>
              Follow your baby's growth and your body's changes every step of the way.
            </p>
            <div style={{ ...styles.badge, background: "rgba(255,154,92,0.2)", color: "#ffbe8f", border: "1px solid rgba(255,154,92,0.3)" }}>
              ● Journey started
            </div>
          </Card>
        </div>
        <div className="fade-up-2" style={styles.btnWrap}>
          <Button title="View My Journey" onClick={() => {}} />
        </div>
      </div>
    </div>
  );
